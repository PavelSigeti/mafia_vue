<template>
  ...
  <Loader v-if="user.role === 'Мирный житель' || store.loader" />
</template>
...
import MafiaNight from '../components/MafiaNight.vue';
import DonCheck from './DonCheck.vue';
import SheriffNight from './SheriffNight.vue';
